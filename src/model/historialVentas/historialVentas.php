  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="collapse">
      <div class="navbar-nav">
        ...
        <a class="nav-link active" href="/PointSale/src/model/historialVentas/historialVentas.php">HISTORIAL</a>
...
<script>
  $('document').ready(function(){
    $('#rellenarVentas').load('/PointSale/src/controller/listar_ventas_efectuadas.php');
  });
  
  function cancelarVenta(id){
    $.post("/PointSale/src/controller/eliminar_venta.php",
  {
    id
  },
