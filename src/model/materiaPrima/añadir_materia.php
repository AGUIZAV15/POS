...
<div class="col-12 col-sm-12">
  ...
  <!-- /POS/src/controller/nuevo_producto.php-->
	<form method="post" action="#">		
        ...
        <input class="btn btn-info" type="button" value="Guardar" id="enviar" onclick="crearNuevaMateria()"><span>&nbsp;&nbsp;</span>        
    <input class="btn btn-secondary" type="button" value="Volver" id="volver" onclick="redirigirAListarMateria()">
	</form>
</div>
</div>
</div>
...
function redirigirAListarMateria(){
    location.href = '/POS/src/model/materiaPrima/listar_materia.php';
}
...
const ex = verificarValor(existencia.value) ? existencia.value : null;
  ...
  if(nom && ex)
  {
    $.post("/POS/src/controller/nueva_materia.php",
  {
